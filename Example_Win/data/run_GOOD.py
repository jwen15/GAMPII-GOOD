...
EXAMPLES: python run_GOOD.py -dir_main D:\data -time 2022 32 3 -ftp cddis -obs daily igs site_igs.list 0 24
          ...
          python run_GOOD.py -dir_main C:\data -time 2022 32 3 -ftp whu -obs daily igs site_igs.list 0 24 -nav daily mixed3 igs 0 24 
             -orbclk igs 0 24 -eop igs 0 24 -obx cod_m -dsb cas -snx -ion all -roti -trop igs site_igs.list -atx
...
def main_run_GOOD():
    ...
    if '-h' in sys.argv or nArgv < 2:
        ...
        with open(cfgFile,"w") as f_w:
            ...
            line += '  biaDir          = bia                          % The sub-directory of CODE/MGEX differential code/signal bias (DCB/DSB), MGEX observable-specific \n'
            ...
            line += '  tblDir          = tables                       % The sub-directory of table files (i.e., ANTEX, ocean tide loading files, etc.) for processing\n'
